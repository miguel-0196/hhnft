  ...
  async function handleMint() {
    if (window.ethereum) {  
      ...
      try {
        ...
        alert("Mint successfully completed")
      } catch (err) {
        console.log('error: ', err)
        alert("Error: Make sure you have enough funds in your wallet and that you are connected to the right network.")
      }
    }
  }
      ...
      <RootStyle>
        ...
        <Container>
          <ContentStyle>
            ...
            { isConnected ? (
                  <m.div variants={varFade().inRight}>
                    ...
                    {/* <Button
                      ...
                      rel="noopener"
                      onClick={handleMint}
                      // href={"https://metamask.app.link/dapp/hangryhippo.io"}
            ...
            <m.div variants={varFade().inRight}>
              <Typography variant="h9" sx={{ color: 'common.white' }}>
                Use browser in Metamask if you run into any issues.
              </Typography>
            </m.div>
          </ContentStyle>
        </Container>
